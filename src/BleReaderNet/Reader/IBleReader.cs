...
namespace BleReaderNet.Reader
{
    ...
    public interface IBleReader
    {
        ...
        Task<int> Scan(string adapterName = null, int scanDurationSeconds = 10);
        ...
        Task<IReadOnlyList<DeviceInfo>> GetAllDevices();
        ...
        Task<T> GetManufacturerData<T>(string macAddress);
    }
}